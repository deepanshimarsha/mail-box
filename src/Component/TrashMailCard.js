    ...
    return (
        ...
        <li className='list-item' style={{backgroundColor : mail.unread? "#f2f6fc":""}}>
                  ...
                  <div className='list-heading'>
                    ...
                    <button className='btn star' onClick={() => dispatch({type : "TOGGLE_STAR_TRASH", mailId: mail.mId})}>{mail.isStarred? "Unstar" : "Star"}</button>
                  </div>
                  ...
                  <button 
                    ...
                    <div className='btn-container'>
                        <button className='btn restore' onClick={() => dispatch({type: "RESTORE_TRASH", mail: mail})}>Restore</button>
                    </div>
