    ...
    return (
        <li className='list-item' style={{backgroundColor : mail.unread? "#f2f6fc":""}}>
                  ...
                  <div className='list-heading'>
                    ...
                    <button className='btn star' onClick={() => dispatch({type : "MARK_AS_STAR", mailId: mail.mId })}>{mail.isStarred? "Unstar" : "Star"}</button>
                  </div>
                  ...
                  <div className='footer'>
                    <button 
                      ...
                      <button 
                        ...
                        onClick={() => dispatch({type: "MARK_AS_READ", mailId : mail.mId, notToggle:false })}
                      >
